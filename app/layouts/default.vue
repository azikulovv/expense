...
<template>
  <div
    class="pt-(--safe-area-top) relative mx-auto flex h-dvh min-h-dvh w-full max-w-107.5 flex-col overflow-hidden text-slate-800 selection:bg-indigo-500 selection:text-white"
  >
