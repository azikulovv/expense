...
<template>
  <div
    class="pt-(--safe-area-top) relative mx-auto flex h-screen min-h-dvh w-full max-w-107.5 flex-col overflow-hidden text-slate-800 selection:bg-indigo-500 selection:text-white"
  >
    ...
    <main
      class="relative z-10 flex-1 overflow-auto p-4 pb-[calc(var(--safe-area-bottom)+100px)]"
    >
      <slot />
    </main>
